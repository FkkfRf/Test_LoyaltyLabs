...
>- [x] *Перейти по порядку на страницы <code><strong> 'Услуги','Проекты','Блог','О компании','Контакты','Услуги'</strong></code>*
>- [x] *На странице <code><strong> 'Услуги' </strong></code> по порядку нажать на каждый из элементов раздела <code><strong> 'Как мы работаем' </strong></code> и вернуться с открывшейся страниы через ссылку <code><strong> 'Все услуги →'</strong></code>*
>- *'элементы в разделе 'Как мы работаем': <code><strong> 'Выделенная команда','Time & Material','Software as a service (SaaS)','Fixed Price'</strong></code>*
