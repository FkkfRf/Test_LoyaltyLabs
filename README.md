...
>- [x] *Проверить что в названии присутствует текст "Разработка IT решений"

> ✓ Тест 2
>- [x] *Открыть сайт __loylabs.ru__*
>- [x] *Перейти по порядку на страницы __'Услуги','Проекты','Блог','О компании','Контакты','Услуги'__*
>- [x] *На странице __'Услуги'__ по порядку нажать на каждый из элементов раздела __'Как мы работаем':__*
>- - *__'Выделенная команда'__,*
>- - *__'Time & Material'__,*
>- - *__'Software as a service (SaaS)'__,*
>- - *__'Fixed Price'__*
> - *Вернуться с каждой открывшейся страниы через ссылку __'Все услуги →'__*
